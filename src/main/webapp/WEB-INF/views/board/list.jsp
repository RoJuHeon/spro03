			...
			<div class='row'>
				<div class="col-lg-12">
					<form id="searchForm" action="/board/list" method="get">
						...
						<button class='btn btn-fault'>Search</button>
					</form>
				</div>
				<!-- pagination -->
				<div class="pull-right">
					<ul class="pagination">
						<c:if test="${pageMaker.prev}">
					   		<li class="paginate-button"><a href="${pageMaker.startPage-1}">Previous</a></li>
					    </c:if>
					    ...
					    <c:if test="${pageMaker.next}">
					    	<li class="paginate-button"><a href="${pageMaker.endPage+1}">Next</a></li>
	  					</c:if>
	  				</ul>
				</div>
